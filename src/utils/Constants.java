...
public class Constants {
    ...
    public static final int MAGE_DAMAGE_BONUS_POINT = 1;
    public static final int MAGE_DAMAGE_BONUS_CHANCE = 33;
    public static final int MAGE_DEFENSE = 3;
    public static final int MAGE_HEALTH = 100;
    public static final int MAGE_CAST_SPECIAL_CHANCE = 15;
